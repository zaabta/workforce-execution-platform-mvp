...
export class AssignWorkerDto {
  @ApiPropertyOptional({
    description:
      'Existing worker id. Omit if providing employeeNo/fullName instead.',
  })
  ...
  @ApiPropertyOptional({
    description:
      'Employee number, used to find-or-create the worker if workerId is not provided.',
  })
  ...
  @ApiPropertyOptional({
    description:
      'Full name, required together with employeeNo when creating a new worker.',
  })
  @IsOptional()
  @IsString()
  fullName?: string;
